                      ...
                      <Table className={classes.table}>
                          ...
                          { todo.map(n => {
                              ...
                              <TableRow key={n._id}>
                                  ...
                                  <TableCell>
                                      <IconButton className={classes.button} aria-label="Delete" onClick={(event) => this.handleDownload(event, n._id)}>
                                          <SvgIcon>
                                              <path d="M16 13h-3V3h-2v10H8l4 4 4-4zM4 19v2h16v-2H4z"/><path d="M0 0h24v24H0z" fill="none"/>
                                          </SvgIcon>
                                      </IconButton>
                                    <IconButton className={classes.button} aria-label="Edit" component='a' href={`/edit-todo/${n._id}`}>
                                      <EditIcon />
                                    </IconButton>
